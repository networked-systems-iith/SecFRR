...
for s in topo.get_p4switches():
    ...
    routing_file_param, shell=True)) # call subprocess  #opens pipe for the command and loads the given command  once this 
    #gets called the execution moves to p4_controller code
    #--switch "+s+"
